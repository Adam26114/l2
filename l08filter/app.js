...
var getli = getul.getElementsByTagName('li'); //HTML collcection
// console.log(getli);
...
function filter(){
    ...
    for(var x = 0 ; x < getli.length ; x++){
        ...
        // console.log(getli[x].getElementsByTagName('a')[0].textContent());
...
// console.log(getli[0].textContent.toLocaleLowerCase());
// console.log(getli[1].textContent.toLocaleLowerCase());


// if(getli[0].textContent.toLowerCase() > getli[1].textContent.toLocaleLowerCase()){
//     console.log('true');
// }else if(getli[0].textContent.toLowerCase() === getli[1].textContent.toLocaleLowerCase()){
//     console.log('equal');
// }else{
//     console.log('false');
// }
